...
/**
	 ...
	 * <dd>return characters that are determined to be ignorable white space.
	 * If the FEATURE_XML_ROUNDTRIP is enabled all whitespace content outside
	 * root element will always reported as IGNORABLE_WHITESPACE otherise
	 * rteporting is optional. <br>
	 ...
	 * <dd> if FEATURE_XML_ROUNDTRIP is true return exact PI content ex: 'pi
	 * foo' from &lt;?pi foo?> otherwise it may be exact PI content or
	 ...
	 * well and are <b>not</b> reported as TEXT tokens but as ENTITY_REF
	 * tokens! This requirement is added to allow to do roundtrip of XML
	 * documents!
	 * <dt>DOCDECL
	 ...
	 * 
	 * <p>
	 * <strong>NOTE:</strong> there is no gurantee that there will only one
