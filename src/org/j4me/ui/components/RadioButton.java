 ...
 * from a list. An example of where radio buttons are useful is to select a
 * logging level. There are a known set of choices and the level is set to one
 * of them.
 * <p>
 ...
 * highlighted it takes them to a screen, similar to a menu, where the user can
...
public class RadioButton extends Component {
	 ...
	 * differently. This component takes the user to another screen based on
	 * <code>Menu</code>.
	 */
	...
	public int[] getPreferredComponentSize(Theme theme, int viewportWidth,
			int viewportHeight) {
		int[] dimensions = box.getPreferredSize(theme, viewportWidth,
				viewportHeight);
	...
	/**
	 * Objects are used by the input screen to show the list of choices and set
	 * the value of the one the user selected.
	 */
	private final class RadioItem implements MenuItem {
		 ...
		 * @param index
		 *            is the element number in <code>choices</code> this menu
		 *            item represents.
		 */
