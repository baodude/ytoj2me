...
/**
 * A horizontal rule component. It is a line across the screen used to demarkate
 * sections of a form.
 */
public class HorizontalRule extends Component {
	 ...
	 *            is the length of the line relative to the width of the screen.
	 *            It must be between 0.00 and 1.00.
	 */
	 ...
	 * 
	 * @param pixels
	 *            is how many pixels high the horizontal line will be. It must
	 *            be at least 1.
	 */
