...
/**
 * The <code>Picture</code> component shows an <code>Image</code>. Typically
 * this is a PNG resource. It can also be an image created manually using the
 * <code>Image.createImage</code> methods.
 * 
...
public class Picture extends Component {
	 ...
	 * 
	 * @param location
	 *            is place in the Jar file the PNG resource is located. For
	 *            example if it were in a directory called <code>img</code> this
	 *            would be <code>"/img/filename.png"</code>.
	 * @throws IOException
	 *             if the PNG could not be loaded from <code>location</code>.
	 */
