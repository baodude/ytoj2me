...
/**
 * Derive this class to set the application's theme. A theme controls the color
 * scheme and background graphics used to skin the application.
 * <p>
 * Themes do not alter the shapes or functionality of components. To change the
 * behavior of appearance of any component it is up to you to derive a new
...
public class Theme {
	...
	/** Yto */
	public static final int YTO = 0x00492B6F;
	/***/
	public static final int BBB = 0x00E2672C;
	/***/
	public static final int CCC = 0x00F28204;
	...
	/**
	 * The percentage of the way down the menu bar that the secondary color used
	 * in the gradient fill is at its max.
	 */
	...
	/**
	 * Creates a <code>Theme</code> object. After creating the theme it must be
	 * attached to the UI manager to use it through the <code>setTheme</code>
	 * method.
	 */
	public Theme() {
	...
	/**
	 * Gets the basic default font. This font is used for writing menu options,
	 * labels, and regular text throughout the UI.
	 * 
	 ...
	 * <p>
	 * By default this font is the system font. Override this font to change the
	 ...
	 * 
	 * @return The font used for writing the title in the title area at the top
	 *         of the screen.
	 ...
	 * <code>getFont</code>. Colors are defined as 0xAARRGGBB; the first-byte
	 ...
	 * will be the color returned by <code>getMenuFontColor</code>. Colors are
	 ...
	 * example of a border is the outline around a text box. Colors are defined
	 ...
	 * screen. This is the area that is not the title bar at the top or menu bar
	 * at the bottom. Colors are defined as 0xAARRGGBB; the first-byte
	 * alpha-channel is ignored.
	 * <p>
	 * Override this method to change it.
	 * 
	...
	/**
	 * Returns the color of the border around the title bar. Colors are defined
	 * as 0xAARRGGBB; the first-byte alpha-channel is ignored.
	 * <p>
	 ...
	 * color defined by <code>getMenuBarHighlightColor</code> is overlaid with a
	 * vertical gradient.
	 * <p>
	 * Colors are defined as 0xAARRGGBB; the first-byte alpha-channel is
	 * ignored.
	 ...
	 * and translated such that (0,0) is the top-left corner of the title bar.
	 * <p>
	...
	/**
	 * Paints the background area of the title bar. The text will be added later
	 * by the calling <code>paintTitleBar</code> method.
	 * 
	 * @param g
	 *            is the <code>Graphics</code> object to paint with.
	 * @param x
	 ...
	 * @see #paintTrackbar(Graphics, int, int, int, int)
	 */
	protected void paintTitleBarBackground(Graphics g, int x, int y, int width,
			int height) {
		...
		gradientFill(g, 0, 0, width, height, true, primary, secondary,
				TITLE_BAR_SECONDARY_COLOR_MAX);
	}

	/**
	 * Gets the height of the menu bar in pixels. This method is called whenever
	 * the menu is going to be painted.
	 * 
	 ...
	 * menu. Be careful not to write strings that are too long and will not fit
	 * on the menu bar.
	 * 
	 * @param g
	 *            is the <code>Graphics</code> object to paint with.
	 ...
	 */
	public void paintMenuBar(Graphics g, String left, boolean highlightLeft,
	...
	/**
	 * Paints the background area of the menu bar. The text will be added later
	 * by the calling <code>paintMenuBar</code> method.
	 * 
	 * @param g
	 *            is the <code>Graphics</code> object to paint with.
	 * @param x
	 ...
	 * @see #paintMenuBar(Graphics, String, boolean, String, boolean, int, int)
	 */
	protected void paintMenuBarBackground(Graphics g, int x, int y, int width,
			int height) {
		...
		gradientFill(g, x, y, width, height, true, primary, secondary,
				MENU_BAR_SECONDARY_COLOR_MAX);
	}
	...
	/**
	 * Gets the localized menu text for Cancel buttons that appear on forms. By
	 * default this is "Cancel".
	 * 
	 ...
	 * <p>
	 * After this method is called, the screen's <code>paintCanvas</code> method
	 * will be.
	 * <p>
	...
	/**
	 * Paints the vertical scrollbar. The scrollbar must go on the right side of
	 * the form and span from the top to the bottom. Its width is returned from
	 * this method and used to calculate the width of the remaining form area to
	 * draw components in.
	 * 
	 * @param g
	 *            is the <code>Graphics</code> object to paint with.
	 ...
	 * @param offset
	 *            is the vertical scrolling position of the top pixel to show on
	 *            the form area.
	 * @param formHeight
	 *            is the total height of all the components on the form. This is
	 *            bigger than <code>height</code>.
	 */
	public void paintVerticalScrollbar(Graphics g, int x, int y, int width,
			int height, int offset, int formHeight) {
		...
		int trackbarHeight = (int) Math
				.floor(height * trackbarPercentage + 0.5);
		...
		int center = y + rangeStart
				+ (int) Math.floor(offsetPercentage * range + 0.5);
	 ...
	 * @see #paintTrackbar(Graphics, int, int, int, int)
	 */
	protected void paintScrollbarBackground(Graphics g, int x, int y,
		...
		gradientFill(g, x, y, width, height, false, primary, secondary,
				SCROLLBAR_SECONDARY_COLOR_MAX);
	}
	...
	/**
	 * Returns the color of the border around the scrollbar. Colors are defined
	 * as 0xAARRGGBB; the first-byte alpha-channel is ignored.
	 * <p>
	 * By default this is the same as the border color. Override this method to
	 * change it.
	 * 
	 ...
	 * <p>
	 * By default this is the same as the menu bar's background color. Override
	 * this method to change it.
	 * 
	 ...
	 */
	public static void gradientFill(Graphics g, int x, int y, int width,
			int height, boolean fillVertically, int primaryColor,
			int secondaryColor, double maxSecondary) {
